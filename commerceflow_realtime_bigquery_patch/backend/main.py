...
ORDERS_PER_BATCH = int(os.getenv("ORDERS_PER_BATCH", "3000"))
SIMULATION_MINUTES = int(os.getenv("SIMULATION_MINUTES", "240"))
MAX_ORDERS_PER_BATCH = max(ORDERS_PER_BATCH, int(os.getenv("MAX_ORDERS_PER_BATCH", str(ORDERS_PER_BATCH))))
BIGQUERY_BACKFILL_BATCH_SIZE = int(os.getenv("BIGQUERY_BACKFILL_BATCH_SIZE", "3000"))
MAX_BIGQUERY_BACKFILL_BATCH_SIZE = max(
    BIGQUERY_BACKFILL_BATCH_SIZE,
    int(os.getenv("MAX_BIGQUERY_BACKFILL_BATCH_SIZE", str(BIGQUERY_BACKFILL_BATCH_SIZE))),
)
AUTO_START_SIMULATION = os.getenv("AUTO_START_SIMULATION", "true").lower() == "true"
GENERATE_INITIAL_BATCH = os.getenv("GENERATE_INITIAL_BATCH", "false").lower() == "true"
